...
class GrEnvCfg(DirectRLEnvCfg):
    ...
    contact_force_reward_weight = 0.4
    contact_count_reward_weight = 0.8
    contact_sustain_reward_weight = 0.8
    lift_support_reward_weight = 1.2
    thumb_proximity_reward_weight = 0.15
    finger_role_reward_weight = 0.4
    opposition_reward_weight = 0.3
    early_anchor_reward_bonus = 0.4
    contact_curriculum_min = 1.0
    ...
    lift_contact_gate_floor = 0.8
    finger_role_curriculum_start_step = 6000
    finger_role_curriculum_end_step = 18000
