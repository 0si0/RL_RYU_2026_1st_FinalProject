...
class GrEnvCfg(DirectRLEnvCfg):
    ...
    fingertip_obj_offset_reward_weight = 0.95
    reference_side_direction_reward_weight = 1.85
    contact_reward_weight = 1.75
    ...
    finger_topology_contact_decay = 0.45
    anchor_rotation_gate_scale = 20.0
    fingertip_reward_scale = 40.0
    fingertip_obj_proximity_reward_scale = 8.0
    reference_side_direction_reward_scale = 7.0
    reference_side_direction_worst_mix = 0.65
    reference_side_direction_weight_floor = 0.45
    reference_side_direction_manipulation_floor = 0.90
    ...
    reference_contact_closure_reward_weight = 0.75
    reference_contact_closure_stable_mix = 0.35
    reference_contact_closure_transport_mix = 0.25
    reference_contact_closure_pair_weight_scale = 0.01
    reference_contact_closure_side_scale = 80.0
    reference_contact_closure_position_scale = 25.0
    stable_grasp_reward_weight = 1.10
    transport_support_reward_weight = 1.20
    obj_future_dir_reward_weight = 0.15
    grasped_hand_ref_reward_weight = 0.6
    task_tracking_reward_weight = 1.05
    ...
    no_contact_mano_imitation_floor = 0.35
    object_relative_reward_base = 0.45
    ...
    no_contact_late_reward_floor = 0.15
    ...
    object_assist_curriculum_steps = 75000
    object_assist_force_gain = 7.5
    object_assist_force_damping = 0.35
    object_assist_torque_gain = 0.55
    object_assist_torque_damping = 0.045
    object_assist_max_force = 1.25
    object_assist_max_torque = 0.10
    object_assist_contact_floor = 0.20
    object_motion_progress_reward_weight = 0.75
    object_motion_progress_linvel_scale = 0.035
    object_motion_progress_angvel_scale = 0.35
    obj_future_dir_min_distance = 0.02
    contact_topk_fingers = 3
    contact_sustain_target_steps = 10.0
    ...
    reference_phase_frame0_ratio = 0.55
    reference_phase_frame0_ratio_start = 0.05
    reference_phase_uniform_ratio_start = 0.10
    reference_phase_uniform_ratio = 0.25
    reference_phase_curriculum_steps = 60000
    reference_phase_weight_scale = 3.0
    reverse_lift_phase_sampling = True
    reverse_lift_phase_ratio_start = 0.80
    reverse_lift_phase_ratio = 0.10
    reverse_lift_curriculum_steps = 75000
    reverse_lift_window_before = 8
    reverse_lift_window_after = 28
    reverse_lift_height_threshold = 0.02
    reverse_lift_height_fraction = 0.35
    success_biased_phase_sampling = True
    success_phase_weight_decay = 0.995
    success_phase_weight_gain = 0.35
